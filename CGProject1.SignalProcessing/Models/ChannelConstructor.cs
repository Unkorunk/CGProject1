...
namespace CGProject1.SignalProcessing.Models
{
    public class ChannelConstructor
    {
        public ChannelConstructor(string modelName, int id, string[] argsNames, string[] varargNames,
            double[] minValues, double[] maxValues, double[] defaultValues, double[][] defaultVarargs,
            Model modelingRule = null)
        {
            this.ModelId = id;
        ...
        public Channel CreatePreviewChannel(int samplesCount, double[] args, double[][] varargs, double samplingFrq,
        ...
        public Channel CreateChannel(int samplesCount, double[] args, double[][] varargs, double samplingFrq,
            DateTime startDateTime)
        {
            this.LastValues = args;
            this.LastVarargs = varargs;
        ...
        private Channel ConstructChannel(int samplesCount, double[] args, double[][] varargs, double samplingFrq,
            DateTime startDateTime)
        {
