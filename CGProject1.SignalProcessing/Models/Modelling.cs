    ...
    public class Modelling
    {
        static Modelling()
        {
            ...
            var delayedPulse = new ChannelConstructor("Задержанный импульс", 0,
                new string[] { "Задержка импульса" }, new string[0], new double[] { double.MinValue },
                new double[] { double.MaxValue }, new double[] { 0 }, null,
            ...
            var delayedRise = new ChannelConstructor("Задержанный скачок", 1,
                new string[] { "Задержка скачка" }, new string[0], new double[] { double.MinValue },
                new double[] { double.MaxValue }, new double[] { 0 }, null,
            ...
            var discretExp = new ChannelConstructor("Дискр. уб. экспонента", 2,
                new string[] { "Основание экспоненты" }, new string[0], new double[] { 0 }, new double[] { 1 },
                new double[] { 0.5 }, null,
                (int n, double dt, double[] args, double[][] varargs, double[] signalVals) =>
                {
            ...
            var discretSin = new ChannelConstructor("Дискр. синусоида", 3,
                ...
                new double[] { 1, Math.PI / 10, 0 }, null,
                (int n, double dt, double[] args, double[][] varargs, double[] signalVals) =>
                {
            ...
            var meandr = new ChannelConstructor("Меандр", 4,
                new string[] { "Период" }, new string[0], new double[] { 2 }, new double[] { double.MaxValue },
                new double[] { 2 }, null,
                (int n, double dt, double[] args, double[][] varargs, double[] signalVals) =>
                {
                    int l = (int)args[0];
            ...
            var withBalancedEnvelope = new ChannelConstructor("С балансной огибающей", 7,
                ...
                {
                    double t = n * dt;
                    return args[0] * Math.Cos(2 * Math.PI * args[1] * t) *
                           Math.Cos(2 * Math.PI * args[2] * t + args[3]);
                });
            ...
            var withTonicEnvelope = new ChannelConstructor("С тональной огибающей", 8,
                new string[]
                {
                    "Амплитуда", "Индекс глубины модуляции", "Частота огибающей", "Частота несущей", "Нач. фаза несущей"
                }, new string[0],
                ...
                {
                    double t = n * dt;
                    return args[0] * (1 + args[1] * Math.Cos(2 * Math.PI * args[2] * t)) *
                           Math.Cos(2 * Math.PI * args[3] * t + args[4]);
                });
